...
export const saveImageController = {
  ...
  findOne: async function (req, res, next) {
    ...
    const response = responseSuccess(
      result,
      `Get saveImage #${req.params.id} successfully`
    );
    res.status(response.statusCode).json(response);
  },
  ...
  update: async function (req, res, next) {
    ...
    const response = responseSuccess(
      result,
      `Update saveImage #${req.params.id} successfully`
    );
    res.status(response.statusCode).json(response);
  },
  ...
  remove: async function (req, res, next) {
    ...
    const response = responseSuccess(
      result,
      `Remove saveImage #${req.params.id} successfully`
    );
    res.status(response.statusCode).json(response);
  },
  ...
  toggleSave: async function (req, res, next) {
    ...
    const response = responseSuccess(result, `Toggle saveImage successfully`);
    res.status(response.statusCode).json(response);
  },
};
