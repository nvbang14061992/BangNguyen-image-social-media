...
# 1. Sequence diagrams
## 1.1 User cases
### 1.1.1 User case 1 - Home page showing all images or image by id
<img src="./Document/images/image-2.png" alt="drawing" width="1000"/>
...
sequenceDiagram
    ...
    F-->>U: Render images in UI
```
### 1.1.2 User case 2 - Details of an image
#### 1.1.2.1 Get image information
```mermaid
sequenceDiagram
    participant U as User (Browser)
...
### 1.1.2.2 Comment to an image
<img src="./Document/images/image-1.png" alt="drawing" width="1000"/>
...
### 1.1.3 User case 3 - Personal profile
#### 1.1.3.1 Edit personal profile
<img src="./Document/images/image-5.png" alt="drawing" width="500"/>
...
### 1.1.4 User case 4 - view other profile
```mermaid
sequenceDiagram
...
## 1.2 Authentication
### 1.2.1 Sign up
<img src="./Document/images/image-3.png" alt="drawing" width="300"/>
...
### 1.2.2 Sign in
<img src="./Document/images/image-4.png" alt="drawing" width="300"/>
